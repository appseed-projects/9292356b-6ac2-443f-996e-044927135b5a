...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-07-13 11:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9292356b-6ac2-443f-996e-044927135b5a.git
$ cd 9292356b-6ac2-443f-996e-044927135b5a
```
